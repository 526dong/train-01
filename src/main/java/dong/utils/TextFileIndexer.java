...
public class TextFileIndexer  {
     ...
     * 存放Lucene索引文件的位置
     */
    public static final String INDEX_PATH = "D:\\export\\lucene\\index";
    /**
     * 需要被扫描的位置，测试的时候记得多在这下面放一些文件
     */
    public static final String SCAN_PATH = "D:\\export\\lucene\\test file";
    ...
    public static void main(String[] args) {
        TextFileIndexer demo = new TextFileIndexer();
        demo.createIndex();
        demo.search("public redis");
    }
}